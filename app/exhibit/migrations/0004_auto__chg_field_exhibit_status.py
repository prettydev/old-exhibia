...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exhibit.status'
        db.alter_column(u'exhibit_exhibit', 'status', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Exhibit.status'
        db.alter_column(u'exhibit_exhibit', 'status', self.gf('django.db.models.fields.CharField')(max_length=15))
