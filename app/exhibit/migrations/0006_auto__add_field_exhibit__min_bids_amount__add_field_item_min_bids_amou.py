...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exhibit._min_bids_amount'
        db.add_column(u'exhibit_exhibit', '_min_bids_amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=20),
                      keep_default=False)

        # Adding field 'Item.min_bids_amount'
        db.add_column(u'exhibit_item', 'min_bids_amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exhibit._min_bids_amount'
        db.delete_column(u'exhibit_exhibit', '_min_bids_amount')

        # Deleting field 'Item.min_bids_amount'
        db.delete_column(u'exhibit_item', 'min_bids_amount')
