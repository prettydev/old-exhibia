...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exhibit.new_bidding_time'
        db.alter_column(u'exhibit_exhibit', 'new_bidding_time', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Item.bidding_time'
        db.alter_column(u'exhibit_item', 'bidding_time', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Exhibit.new_bidding_time'
        db.alter_column(u'exhibit_exhibit', 'new_bidding_time', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'Item.bidding_time'
        db.alter_column(u'exhibit_item', 'bidding_time', self.gf('django.db.models.fields.SmallIntegerField')())
