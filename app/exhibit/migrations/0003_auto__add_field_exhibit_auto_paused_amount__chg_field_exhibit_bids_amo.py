...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exhibit.auto_paused_amount'
        db.add_column(u'exhibit_exhibit', 'auto_paused_amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Exhibit.bids_amount'
        db.alter_column(u'exhibit_exhibit', 'bids_amount', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):
        # Deleting field 'Exhibit.auto_paused_amount'
        db.delete_column(u'exhibit_exhibit', 'auto_paused_amount')


        # Changing field 'Exhibit.bids_amount'
        db.alter_column(u'exhibit_exhibit', 'bids_amount', self.gf('django.db.models.fields.BooleanField')())
