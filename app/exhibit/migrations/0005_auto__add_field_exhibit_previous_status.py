...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exhibit.previous_status'
        db.add_column(u'exhibit_exhibit', 'previous_status',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exhibit.previous_status'
        db.delete_column(u'exhibit_exhibit', 'previous_status')
