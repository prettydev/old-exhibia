...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExhibitWinnerPost.notified'
        db.delete_column(u'screen_capture_exhibitwinnerpost', 'notified')


    def backwards(self, orm):
        # Adding field 'ExhibitWinnerPost.notified'
        db.add_column(u'screen_capture_exhibitwinnerpost', 'notified',
