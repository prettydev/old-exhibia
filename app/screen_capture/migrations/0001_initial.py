...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExhibitWinnerPost'
        db.create_table(u'screen_capture_exhibitwinnerpost', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('notified', self.gf('django.db.models.fields.BooleanField')()),
            ('exhibit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exhibit.Exhibit'])),
        ))
        db.send_create_signal(u'screen_capture', ['ExhibitWinnerPost'])

    def backwards(self, orm):
        # Deleting model 'ExhibitWinnerPost'
        db.delete_table(u'screen_capture_exhibitwinnerpost')
    ...
    models = {
        ...
        u'exhibit.exhibit': {
            ...
            '_min_bids_amount': ('django.db.models.fields.PositiveIntegerField', [], {'default': '20'}),
            'amount_funded': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'auto_paused_amount': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'backers_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'bids_amount': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            ...
            'new_bidding_time': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'paused_unixtime': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'previous_status': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'started_unixtime': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'funding'", 'max_length': '20', 'db_index': 'True'})
        },
        u'exhibit.item': {
            'Meta': {'object_name': 'Item'},
            'amount': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'bidding_time': ('django.db.models.fields.PositiveIntegerField', [], {'default': '600'}),
            ...
            'min_bids_amount': ('django.db.models.fields.PositiveIntegerField', [], {'default': '20'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        u'screen_capture.exhibitwinnerpost': {
            'Meta': {'object_name': 'ExhibitWinnerPost'},
            'exhibit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exhibit.Exhibit']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'notified': ('django.db.models.fields.BooleanField', [], {})
        }
    }

    complete_apps = ['screen_capture']